            ...
            <div v-for="(product, index) in products" :key="index" class="product-card"
                ...
                <div class="product-info">
                    ...
                    <div class="button-container">
                        <button class="add-btn" @click="addToCart(product)" :disabled="isAddToCartDisabled(product)">
...
export default {
    ...
    methods: {
        ...
        isAddToCartDisabled(product) {
            const cartQuantity = this.$store.getters['cart/getCartItemQuantity'](product.id);
            return cartQuantity >= product.stock; // Disable if cart quantity is equal to or greater than stock
        }
    }
};
</script>
